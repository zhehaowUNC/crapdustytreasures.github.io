...
function myFunction() {
  ...
  var isempty = true;
	...
	if (isempty){
		input.style.marginBottom = "300px";
	}
  for (i = 0; i < li.length; i++) {
  	if (li[i].style.display !== "none") {
  		last = li[i];
...
function fuck(){
	var list = document.getElementsByClassName('songs');
	list[list.length-1].style.marginBottom = "100px";
...
function detect(li){
	...
	if (isempty){
		input.style.marginBottom = "600px";
	}
}
